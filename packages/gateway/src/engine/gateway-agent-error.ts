...
function buildAgentErrorMessage(init: AgentUnavailableInit): string {
  ...
  switch (init.reason) {
    ...
    case "model_not_found":
      return `${provider} returned 404 for the configured model. Check NIMBUS_OPENAI_MODEL / NIMBUS_OPENAI_CLASSIFIER_MODEL / NIMBUS_ANTHROPIC_MODEL or your access tier.`;
    case "provider_error": {
