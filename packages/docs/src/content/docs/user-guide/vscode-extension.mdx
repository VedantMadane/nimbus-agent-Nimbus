...
<Tabs>
  ...
  <TabItem label="Open VSX (Cursor / VSCodium)">
    ...
    ```bash
    # Cursor
    cursor --install-extension nimbus-agent.nimbus

    # VSCodium
    codium --install-extension nimbus-agent.nimbus
    ```
  ...
  <TabItem label="Manual (.vsix)">
    ...
    [GitHub Release](https://github.com/asafgolombek/Nimbus/releases) for your
...
<CardGrid>
  ...
  <LinkCard
    ...
    href="https://marketplace.visualstudio.com/items?itemName=nimbus-agent.nimbus"
