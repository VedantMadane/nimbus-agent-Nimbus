...
| `packages/client` | `@nimbus-dev/client` — typed IPC wrapper used by the CLI, the desktop app, and integrators. |
...
| `packages/vscode-extension` | The Nimbus VS Code extension. |
