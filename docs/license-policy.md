...
The current overrides are documented in the source. As of `v0.1.0`:

- `@vscode/vsce-sign@2.0.9`, `@vscode/vsce-sign-win32-x64@2.0.6` — Microsoft VSCE signing tooling; redistribution permitted by the LICENSE.txt for vsce-driven extension publishing; not bundled into the gateway binary.
