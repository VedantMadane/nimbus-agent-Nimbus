 ...
 * existing `workflow_run` table (v9 schema). The runner writes dry-run rows
 * (previously short-circuited before INSERT) and records the per-invocation
 * params override so the UI can surface it in the run-history drawer.
 *
