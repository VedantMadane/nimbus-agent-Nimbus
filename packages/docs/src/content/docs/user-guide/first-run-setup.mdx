...
![Onboarding welcome page](../../../assets/onboarding-welcome.png)
...
![Desktop app onboarding showing the service selection step](../../../assets/onboarding-service-selection.png)
...
![Onboarding syncing step with live item counter](../../../assets/onboarding-syncing.png)
...
{/* TODO: screenshot — system tray icon and right-click menu */}
...
![Quick Query popup showing a streaming response](../../../assets/quick-query.png)
